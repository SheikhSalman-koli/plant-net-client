...
// TODO: cancel order
  ...
  const{plantImage, plantName, plantQuantity, 
plantPrice, plantCategory, status
} = order|| {}
// console.log(order);
  ...
  return (
    <tr>
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        <p className='text-gray-900 whitespace-no-wrap'>${plantPrice}</p>
      </td>
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        <p className='text-gray-900 whitespace-no-wrap'>{plantQuantity}</p>
      </td>
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
